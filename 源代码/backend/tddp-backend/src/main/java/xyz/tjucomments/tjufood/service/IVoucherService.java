...
public interface IVoucherService extends IService<Voucher> {
     ...
     * 分页条件查询优惠券列表
     */
    Result searchVouchers(Integer current, Integer size, Integer type, Long canteenId, Integer status);
     ...
     * @return 操作结果
     */
    Result createVoucherOrder(Long voucherId, Long userId, Integer requiredCredits);
}