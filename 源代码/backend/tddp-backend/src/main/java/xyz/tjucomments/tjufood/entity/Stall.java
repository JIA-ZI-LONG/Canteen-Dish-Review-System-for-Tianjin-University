// 文件路径: back/src/main/java/xyz/tjucomments/tjufood/entity/Stall.java
...
public class Stall {
    ...
    // ▼▼▼ 【新增】补全缺失的字段 ▼▼▼
    @Schema(description = "人均价格", accessMode = Schema.AccessMode.READ_ONLY)
    ...
    @Schema(description = "总评分（用于增量计算）", accessMode = Schema.AccessMode.READ_ONLY)
    @TableField("total_score")
    private Double totalScore;

    @Schema(description = "口味总分（用于增量计算）", accessMode = Schema.AccessMode.READ_ONLY)
    @TableField("total_taste_score")
    private Double totalTasteScore;

    @Schema(description = "环境总分（用于增量计算）", accessMode = Schema.AccessMode.READ_ONLY)
    @TableField("total_environment_score")
    private Double totalEnvironmentScore;

    @Schema(description = "服务总分（用于增量计算）", accessMode = Schema.AccessMode.READ_ONLY)
    @TableField("total_service_score")
    private Double totalServiceScore;

    @Schema(description = "性价比总分（用于增量计算）", accessMode = Schema.AccessMode.READ_ONLY)
    @TableField("total_price_score")
