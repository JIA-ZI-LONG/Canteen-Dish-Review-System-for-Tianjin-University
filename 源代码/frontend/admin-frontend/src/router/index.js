...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'log', name: 'LogManagement', component: LogManagementView, meta: { title: '日志管理' } },
      {
        ...
        component: () => import('@/views/operation_mgr/VoucherManagementView.vue'),
        meta: { title: '优惠券管理' }
      },
    ]
  },
  ...
  },
  {
    ...
    children: [
      { path: 'help-doc', name: 'HelpDoc', component: HelpDocView, meta: { title: '在线帮助文档', roles: ['系统管理员', '内容管理员', '社区管理员', '运营管理员'] } },
      { path: 'export-log', name: 'ExportLog', component: ExportLogView, meta: { title: '操作日志导出', roles: ['系统管理员'] } },
      { path: 'export-db', name: 'ExportDb', component: ExportDbView, meta: { title: '数据库数据导出', roles: ['系统管理员'] } },
      { path: 'statistics', name: 'StatisticsDashboard', component: StatisticsDashboardView, meta: { title: '数据大屏', roles: ['系统管理员'] } },
      { path: 'api-doc', name: 'ApiDoc', component: ApiDocView, meta: { title: 'API文档', roles: ['系统管理员'] } },
      { path: 'api-management', name: 'ApiManagement', component: () => import('@/views/toolbox/ApiManagementView.vue'), meta: { title: 'API管理', roles: ['系统管理员'] } },
      { path: 'audit-log', name: 'AuditLog', component: () => import('@/views/toolbox/AuditLogView.vue'), meta: { title: '审计日志', roles: ['系统管理员'] } },
      { path: 'task', name: 'TaskManagement', component: TaskManagementView, meta: { title: '定时任务管理', roles: ['系统管理员'] } },
    ]
  },
