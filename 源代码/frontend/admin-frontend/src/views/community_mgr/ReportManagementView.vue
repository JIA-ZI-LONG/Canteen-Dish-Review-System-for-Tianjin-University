    ...
    <el-card class="report-card">
      ...
      <div class="search-container">
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-select v-model="searchForm.targetType" placeholder="请选择举报类型" clearable style="width: 100%">
      ...
      <div v-if="currentReport">
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            <p><strong>举报类型：</strong>{{ getTargetTypeText(currentReport.targetType) }}</p>
          </el-col>
          <el-col :span="12">
        ...
        <el-form ref="processForm" :model="processForm" :rules="processRules" label-width="100px" style="margin-top: 20px;">
          <el-form-item label="处理结果" prop="status">
            <el-radio-group v-model="processForm.status">
              <el-radio :label="1">举报属实，已处理</el-radio>
              <el-radio :label="2">举报不实，已驳回</el-radio>
            </el-radio-group>
          </el-form-item>
      ...
      <div v-if="currentReport">
        ...
        <el-row>
          <el-col :span="24">
            ...
            <p v-if="currentReport.result"><strong>处理说明：</strong></p>
