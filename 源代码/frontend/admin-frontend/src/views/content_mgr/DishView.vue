  ...
  <div class="dish-container">
    <el-card class="dish-card">
      ...
      <el-table :data="list" border fit highlight-current-row v-loading="listLoading">
        ...
        <el-table-column prop="stallName" label="所属窗台"></el-table-column>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="菜品名称" prop="name">
              <el-input v-model="dishForm.name" placeholder="请输入菜品名" prefix-icon="el-icon-food"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所属窗堂" prop="stallId">
              <el-select v-model="dishForm.stallId" placeholder="请选择所属窗堂" filterable style="width: 100%">
...
export default {
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        stallId: [
          { required: true, message: '请选择所属窗堂', trigger: 'change' }
        ],
        price: [
  ...
  methods: {
    ...
    fetchSupportData() {
      request({ url: '/admin/stalls', method: 'get', params: { current: 1, size: 1000 } }).then(res => { this.stallList = res.records || [] })
    },
